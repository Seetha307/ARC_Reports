<html>
	<head>
		...
		<meta name="Author" content="Easwar_Elumalai"/>
		<meta name="Manager" content=""/>
		<meta name="Company" content="Infosys Technologles Ltd"/>
...
var g_FileList = new  Array(
 new FileEntry (1, 0, "Use Case-1", "vml_1.htm", "gif_1.htm")
	...
	<frameset id="frmstOuter" cols="237,*" title="Drawing1">
		...
		<noframes>
			<body>
				...
				<h1>Drawing1</h1>
				<ul>
				<li><a href="Drawing1_files/gif_1.htm">Use Case-1</a></li>
